...
public class EquipamentosDAO {
    ...
    // INSERIR
    public boolean inserir(Equipamentos e) throws Exception {
    ...
    // BUSCAR POR CÓDIGO
    public Equipamentos buscarPorCodigo(String codigo) throws Exception {
    ...
    // PESQUISAR POR NOME
    public List<Equipamentos> pesquisarPorNome(String nome) throws Exception {
    ...
    // LISTAR TODOS
    public List<Equipamentos> listarTodos() throws Exception {
        List<Equipamentos> lista = new ArrayList<>();
    ...
    // BUSCAR POR ID
    public Equipamentos buscarPorId(int id) throws Exception {
    ...
    // ATUALIZAR
    public boolean atualizar(Equipamentos e) throws Exception {
